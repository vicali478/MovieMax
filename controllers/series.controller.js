...
const popularFile = path.resolve(__dirname, "../popular_tvs.json");
...
exports.getPopularTvs = async (req, res, next) => {
  ...
  const detailed = await getPopularTvDetails(items);

  res.json({ category: 'popular', page, totalPages, tvs: detailed });
